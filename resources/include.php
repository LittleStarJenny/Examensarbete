...
include($_SERVER['DOCUMENT_ROOT'].'/Stellasina/resources/classes/customer.php');
include($_SERVER['DOCUMENT_ROOT'].'/Stellasina/resources/classes/order.php');
include($_SERVER['DOCUMENT_ROOT'].'/Stellasina/resources/classes/admin.php');
